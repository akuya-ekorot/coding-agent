...
const readFile = async (
	...
	try {
		// Get working directory from runtime context or fall back to process.cwd()
		const workingDirectory =
			runtimeContext?.get?.("working-directory") || process.cwd();
